...
export default function Bookings() {
  ...
  return (
    <div>
      {bookings?.length > 0 && bookings.map((place, index) => (
            ...
            <div className="flex flex-col sm:flex-row gap-4 bg-gray-200 rounded-2xl overflow-hidden mt-4 shadow-md">
              ...
              <div className="py-3 grow px-3">
                ...
                <div className="border-t border-gray-300 mt-2 py-2 ">
                  <BookingDates place={place} className={"font-semibold text-gray-500"}/>
                  <p className="mt-2 text-sm sm:text-base md:text-lg lg:text-xl text-gray-700 font-semibold"> Total price: &#8377;{place.price}/-</p>
                </div>
              </div>
            </div>
          )}
